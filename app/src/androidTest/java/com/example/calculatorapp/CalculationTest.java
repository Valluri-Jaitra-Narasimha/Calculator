...
public class CalculationTest {
    ...
    public void multiplyTwoNumbers() {
        ...
        onView(withId(R.id.btn_three)).perform(click());
        onView(withId(R.id.btn_equalsto)).perform(click());
        onView(withId(R.id.edt_calculation)).check(matches(withText("24")));
    }
    ...
    public void divideTwoNumbers() {
        ...
        onView(withId(R.id.btn_three)).perform(click());
        onView(withId(R.id.btn_equalsto)).perform(click());
        onView(withId(R.id.edt_calculation)).check(matches(withText("3")));
    }
    ...
    public void calculateDollars() {
        ...
        onView(withId(R.id.btn_dollar)).perform(click());
        try {

            wait(20000);
            onView(withId(R.id.edt_calculation)).check(matches(withText("319.78958")));
