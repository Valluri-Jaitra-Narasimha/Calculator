...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btn_plus, btn_minus, btn_multiply, btn_divide, btn_percentage,btn_dollar;
    ...
    private void checkingLastCharOfEditTextOnDollarPress(String buttonText, String editTextData, int lengthOfEditTextData, char lastCharOfEditTextData) {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_dollar:
                String buttonText_dollar = btn_dollar.getText().toString();
                String editTextData_dollarPress = edt_calculation.getText().toString();
                int lengthOfEditTextData_dollarPress = edt_calculation.getText().toString().length();

                char lastCharOfEditTextData_dollarPress = editTextData_dollarPress.charAt(lengthOfEditTextData_dollarPress - 1);

                checkingLastCharOfEditTextOnDollarPress(buttonText_dollar, editTextData_dollarPress, lengthOfEditTextData_dollarPress, lastCharOfEditTextData_dollarPress);
                break;
            ...
            case R.id.btn_equalsto:
                ...
                if (text.contains("+")) {
                    ...
                    final String number1 = edt_calculation.getText().subSequence(0, text.indexOf("$")).toString();


                    String API= "https://exchange-rates.abstractapi.com/v1/live/?api_key=87871450605d4bd4a3eb09d5e9808f9f&base=USD&target=INR";
                    ...
                    JsonObjectRequest objectRequest=new JsonObjectRequest(Request.Method.GET, API, null,
                            ...
                            new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                    int i = response.toString().indexOf("INR");
                                    int j=response.toString().lastIndexOf("}}");
                                    Double result = new Calculation().multiplyTwoNumbers(Double.parseDouble(number1),Double.parseDouble(response.toString().substring(i+5,j)));
                                    edt_calculation.setText(result.toString());
                                    taskComplete = true;
                                }
                            },
